...
var todo = new Todo({name: 'Master NodeJS test', completed: false, note: 'Getting there...'});
// Save it to database
...
Todo.create({name: 'Create something with Mongoose test', completed: true, note: 'this is one'}, function(err, todo){
...
Todo.update({ name: /master/ }, { completed: true }, { multi: true }, callback);
